...
def generate_certificate(request):
    ...
    template_path = os.path.join('accounts/static/images/htmlcertificate.png')  # Replace with the path to your font file
    ...
    font_path = os.path.join('accounts/static/images/Roboto-Medium.ttf')  # Replace with the path to your font file
...
def generate_pythoncertificate(request):
    ...
    # Load the existing certificate PNG template
    template_path =  os.path.join( 'accounts/static/images/pythoncertificate.png')
    # Create a response object to store the PNG
    response = HttpResponse(content_type='image/png')
    response['Content-Disposition'] = f'filename={user.username}_certificate.png'
...
def send_pythoncertificate_email(request):
    ...
    print(total_score)
    # Load the existing certificate PNG template
    template_path = os.path.join('accounts/static/images/pythoncertificate.png')  # Replace with the path to your font file
    ...
    # Return a response indicating the certificate has been sent
    return redirect('generate_pythoncertificate')
...
def generate_phpcertificate(request):
    ...
    print(total_score)
    # Load the existing certificate PNG template
    template_path = os.path.join('accounts/static/images/phpcertificate.png')  # Replace with the path to your font file
    ...
    if request.method == 'POST':
        ...
        if email and phone and resume:
            ...
            email = EmailMessage(
                ...
                settings.EMAIL_HOST_USER,  # Replace with your email address
                [email],  # Send to the authenticated user's email address
            )
